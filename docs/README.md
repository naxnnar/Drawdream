...
| ไฟล์ | ใช้ทำอะไร |
|------|------------|
| [FEATURE_FILES_SUMMARY_TH.md](FEATURE_FILES_SUMMARY_TH.md) | สรุปไฟล์ตามฟีเจอร์: ใบเสร็จอิเล็กทรอนิกส์ · อัปเดตผลลัพธ์มูลนิธิ · แอดมินดูผู้บริจาค/บริจาค · รายงานเชิงวิเคราะห์ |
